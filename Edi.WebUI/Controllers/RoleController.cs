...
namespace Edi.WebUI.Controllers
{
    public class RoleController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            foreach (var role in _db.ApplicationRoles)
            {
        ...
        public ActionResult Edit(string id)
        {
            ...
            var role = _db.ApplicationRoles.First(r => r.Name == id);
            ...
            "RoleName,OriginalRoleName,Description")] EditRoleViewModel model)
        {
            if (ModelState.IsValid)
            {
                var role = _db.ApplicationRoles.First(r => r.Name == model.OriginalRoleName);
